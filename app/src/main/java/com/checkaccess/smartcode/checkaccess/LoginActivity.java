    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                //getRepoList(mEmailView.getText().toString(), mEmailView.getText().toString());
        ...
        private void getRepoList(String username, String password) {
            // First, we insert the username into the repo url.
            // The repo url is defined in GitHubs API docs (https://developer.github.com/v3/repos/).
            url = baseUrl + username + "/repos/" + password;
                            ...
                            if (response.length() > 0) {
                                ...
                                for (int i = 0; i < response.length(); i++) {
                                    try {
                                        ...
                                        String repoName = jsonObj.get("status").toString();
                                        String lastUpdated = jsonObj.get("error").toString();
